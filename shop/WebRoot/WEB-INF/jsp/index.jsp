...
<!-- 					<div class="hotProductAd">
			<img src="image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
						             <s:iterator var="phot" value="hList">
									<li>
										<a href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="#phot.pid"/>" target="_blank">
										<img src="${pageContext.request.contextPath}/<s:property value="#phot.image"/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;">
										</a>
									</li> 
									</s:iterator>
						</ul>
...
<!-- 					<div class="newProductAd">
						 ...
						 -->						
						 <ul class="tabContent" style="display: block;">
						           <s:iterator var="pnew" value="nList">
									<li>
										<a  href="${pageContext.request.contextPath}/product_findByPid?pid=<s:property value="#pnew.pid"/>"target="_blank"><img src="${pageContext.request.contextPath}/<s:property value="#pnew.image"/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									</li>
										</s:iterator>
									</li>
						</ul>
						<ul class="tabContent" style="display: none;">
