...
<link href="./css/register.css" rel="stylesheet" type="text/css"/>
 <script >
  ...
  function createXmlHttp(){
		 ...
		 function change(){
		    var image1=document.getElementById("checkImage");
		    image1.src="${pageContext.request.contextPath}/checkImage.action?"+new Date().getTime();
		 }
 </script>
</head>
<body>
						...
						<table>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkImage" class="captchaImage" src="${pageContext.request.contextPath}/checkImage.action" onclick="change()"  "点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
